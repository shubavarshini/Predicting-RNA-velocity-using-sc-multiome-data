...
2. velocyto.sh - SLURM submission script for running the Velocyto package for individual BAM files. NOTE: Change sbatch options as per your SLURM plateform parameters or other cluster submission services.
